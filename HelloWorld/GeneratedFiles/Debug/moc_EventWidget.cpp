...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_EventWidget_t, stringdata) + ofs \
...
const QMetaObject EventWidget::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_EventWidget.data,
      qt_meta_data_EventWidget,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *EventWidget::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_EventWidget.stringdata))
